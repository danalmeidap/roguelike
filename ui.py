...
def draw_menu(screen, audio_on, menu_selection):
    screen.clear()
    ...
    screen.draw.filled_rect(start_button_rect, highlight_color if menu_selection == 0 else normal_color)
    screen.draw.filled_rect(sound_button_rect, highlight_color if menu_selection == 1 else normal_color)
    screen.draw.filled_rect(exit_button_rect, highlight_color if menu_selection == 2 else normal_color)
